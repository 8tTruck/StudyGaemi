...
//        }
        ...
        scrollView.snp.makeConstraints { make in
            make.top.equalTo(additionalSafeAreaInsets).offset(12)
            make.leading.trailing.equalTo(additionalSafeAreaInsets).inset(24)
            make.bottom.equalTo(additionalSafeAreaInsets).offset(12)
        }
